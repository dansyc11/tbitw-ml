...
int main(void) {
    ...
    MNIST_Dataset test = mnist_load(&arena, "data/fashion-t10k-images-idx3-ubyte", 
    ...
    while (1) {
        ...
        print_image(img);
	printf("\nPrediction: %u (%s) - %.1f%% confidence\n", 
	pred, fashion_labels[pred], max_confidence * 100);
	printf("True label: %u (%s)\n", 
	true_label, fashion_labels[true_label]); 
