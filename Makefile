...
all: xor mnist mnist_adam mnist_inference mnist_predict fashion fashion_predict
...
fashion: $(SRC) src/tbitw_mnist.c examples/fashion_mnist.c
	$(CC) $(CFLAGS) $^ $(LIBS) -o $@

fashion_predict: $(SRC) src/tbitw_mnist.c examples/fashion_predict.c
	$(CC) $(CFLAGS) $^ $(LIBS) -o $@

clean:
	rm -f xor mnist mnist_adam mnist_inference mnist_predict fashion fashion_predict
.PHONY: all clean
